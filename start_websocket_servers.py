...
call_alice = [python, str(FILE_PATH), "--port", "8777", "--id", "alice"]

call_bob = [python, str(FILE_PATH), "--port", "8778", "--id", "bob"]

call_charlie = [python, str(FILE_PATH), "--port", "8779", "--id", "charlie"]
